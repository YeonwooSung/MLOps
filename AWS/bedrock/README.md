...
Most of the codes in this directory are based on the [amazon-bedrock-samples](https://github.com/aws-samples/amazon-bedrock-samples).
Credits to the AWS team for providing the samples.
